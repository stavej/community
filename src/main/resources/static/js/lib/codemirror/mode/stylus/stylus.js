...
(function(mod) {
  ...
  var wordOperators = ["in", "and", "or", "not", "is a", "is", "isnt", "defined", "if unless"],
      ...
      commonDef = ["@font-face", "@keyframes", "@media", "@viewport", "@offset", "@host", "@supports", "@block", "@css"],
